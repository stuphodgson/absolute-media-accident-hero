$(document).ready(function () {
    ...
    `
	$("#privacy_policy_modal div.content").append(privacy_policy_modal_content);
	$("#cookie_policy_modal div.content").append(cookie_policy_modal_content);
	$("#complaints_procedure_modal div.content").append(complaints_procedure_modal_content);
	$("#contact_us_modal div.content").append(contact_us_modal_content);
});